### Ключевые слова для поиска информации в интернете: декомпозиция, файлы, путь к файлу, файловая структура.
...
* [Официальная документация:](https://docs.python.org/3/tutorial/controlflow.html)
